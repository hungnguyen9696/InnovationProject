...
import { getPostsChemistry } from "../../actions/postActions";
import { Link } from "react-router-dom";

class PostsChemistry extends Component {
  componentDidMount() {
    this.props.getPostsChemistry();
  }
...
PostsChemistry.propTypes = {
  getPostsChemistry: PropTypes.func.isRequired,
