...
import { getPostsMovies } from "../../actions/postActions";
import { Link } from "react-router-dom";

class PostsMovies extends Component {
  componentDidMount() {
    this.props.getPostsMovies();
  }
...
PostsMovies.propTypes = {
  getPostsMovies: PropTypes.func.isRequired,
