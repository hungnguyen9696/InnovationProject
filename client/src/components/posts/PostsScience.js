...
import { getPostsScience } from "../../actions/postActions";
import { Link } from "react-router-dom";

class PostsScience extends Component {
  componentDidMount() {
    this.props.getPostsScience();
  }
...
PostsScience.propTypes = {
  getPostsScience: PropTypes.func.isRequired,
